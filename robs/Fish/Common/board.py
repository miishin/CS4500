...
class Board:
	...
	@staticmethod
	def northEast(col: int, row: int, index: int):
		"""
	...
	@staticmethod
	def southEast(col: int, row: int, index: int):
		"""
	...
	@staticmethod
	def northWest(col: int, row: int, index: int):
		"""
	...
	@staticmethod
	def southWest(col: int, row: int, index: int):
		"""
	...
	@staticmethod
	def north(col: int, row: int, index: int):
		"""
	...
	@staticmethod
	def south(col: int, row: int, index: int):
		"""
