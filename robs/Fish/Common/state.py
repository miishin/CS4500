...
class State:
	...
	#TODO: Most methods below are not used anywhere and we should consider removing them
	...
	def deletePlayer(self, playerIndex):
		...
		:param color: PenguinColor the enum that indicates the color of a player's penguins
		:return: None
		"""
